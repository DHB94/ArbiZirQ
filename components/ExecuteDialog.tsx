...
import { Loader2, Zap, ExternalLink, CheckCircle, AlertTriangle } from 'lucide-react'
...
export function ExecuteDialog({
  ...
  const handleExecute = async () => {
    ...
    try {
      ...
      onComplete(true, `Execution successful! Tx: ${result.txHash}`)
    } catch (error) {
                ...
                <CardContent className="pt-4">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm">
                      <p className="font-medium text-yellow-800">Risk Warning</p>
                      <p className="text-yellow-700 mt-1">
                        This will execute real trades with real funds. 
                        Arbitrage involves cross-chain transactions that 
                        may fail or incur unexpected costs.
                      </p>
                    </div>
                  </div>
                </CardContent>
